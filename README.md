...
## License
See the [LICENSE](LICENSE.md) file for license rights and limitations (MPL-2.0)[![License: MPL 2.0](https://img.shields.io/badge/License-MPL%202.0-brightgreen.svg)](https://opensource.org/licenses/MPL-2.0)

Parts made by Create React App itself might be BSD-3-Clause.
